...
By default, the
:meth:`JSONLoader.load() <psp.processors.json_processor.JSONLoader.load>`
...
reinforced by :class:`~psp.processors.json_processor.JSONLoader` or
:class:`~psp.processors.json_processor.JSONDumper`, although
